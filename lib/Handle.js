...
var Handle = function (_React$Component) {
  ...
  Handle.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        restProps = (0, _objectWithoutProperties3['default'])(_props, ['prefixCls', 'vertical', 'offset', 'style', 'disabled', 'min', 'max', 'value', 'tabIndex', 'aria-label', 'aria-labelledby', 'ariaValueTextFormatter']);


    var className = (0, _classnames2['default'])(this.props.className, (_classNames = {}, _classNames[prefixCls + '-handle-click-focused'] = this.state.clickFocused, _classNames));
    ...
    if (value !== undefined) {
      ...
      if (ariaValueTextFormatter) {
        ariaProps['aria-valuetext'] = ariaValueTextFormatter(value);
      }
    }
