...
var Range = function (_React$Component) {
  ...
  Range.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        ariaValueTextFormatter = _props2.ariaValueTextFormatter;
...
Range.propTypes = {
  ...
  'aria-label': _propTypes2['default'].arrayOf(_propTypes2['default'].string),
  'aria-labelledby': _propTypes2['default'].arrayOf(_propTypes2['default'].string),
  ariaValueTextFormatter: _propTypes2['default'].arrayOf(_propTypes2['default'].func)
};
Range.defaultProps = {
  count: 1,
  allowCross: true,
